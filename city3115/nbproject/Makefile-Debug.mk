...
${OBJECTDIR}/opticalFlow.o: opticalFlow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/opticalFlow.o opticalFlow.cpp
